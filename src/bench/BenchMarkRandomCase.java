...
public class BenchMarkRandomCase
{
   @Param({
         TestCasesBasePath + "RandomOrder_1000.txt",
         TestCasesBasePath + "RandomOrder_10000.txt",
         TestCasesBasePath + "RandomOrder_100000.txt",
         TestCasesBasePath + "RandomOrder_1000000.txt"
   })
